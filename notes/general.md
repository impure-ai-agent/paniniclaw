...
If the directory you are in is a git repository commit any changes so we can see history.
Do not use curl directly as it wastes tokens, instead you can run `./clean_curl.py <url>` which strips HTML tags.
